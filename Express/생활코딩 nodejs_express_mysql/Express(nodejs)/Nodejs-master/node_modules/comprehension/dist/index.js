...
function isUnsignedSafeInteger(a) {
...
function $(props, map) {
    ...
    if (typeof props === 'number') {
        if (!isUnsignedSafeInteger(props))
            throw new Error('count is not unsigned safe integer');
